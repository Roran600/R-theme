...
`;
  ...
  // ns-hugo:/home/roran/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/header@v0.14.5/assets/hb/modules/header/js/index.ts
  (() => {
    document.addEventListener("DOMContentLoaded", () => {
  ...
  // ns-hugo:/home/roran/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/gallery@v0.13.0/assets/hb/modules/gallery/js/index.ts
  (() => {
    document.addEventListener("DOMContentLoaded", () => {
      const loaded = (img) => {
  ...
  // ns-hugo:/home/roran/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/base@v0.6.0/assets/hb/modules/base/js/responsive-table.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:/home/roran/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/carousel@v0.2.5/assets/hb/modules/carousel/js/index.ts
  (() => {
  ...
  // ns-hugo:/home/roran/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/docs@v0.17.2/assets/hb/modules/docs/js/nav.ts
  (() => {
  ...
  // ns-hugo:/home/roran/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/hbstack/docs@v0.17.2/assets/hb/modules/docs/js/nav-toggle.ts
  (() => {
  ...
  var header = { banner: { navbar_opacity: 0.8, transparentize_navbar_bg: true }, brand: "Roran60 Blog", breakpoint: "lg", full_width: true, logo_bg: "#712cf9", socials: { github: "hbstack", mastodon: "https://techhub.social/@hbstack", rss: true }, sticky: true, theme_toggle: { style: "switch" } };
